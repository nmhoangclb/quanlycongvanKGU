<?php
	...
	$result = mysqli_query($conn, "SELECT * FROM congvan, taptin WHERE congvan.mataptin = taptin.id AND hinhthucvanban = 1 ORDER BY idcongvan DESC LIMIT $start, $limit");//Desc giảm dần Asc tăng dần
	?>
<div>
	<?php 
