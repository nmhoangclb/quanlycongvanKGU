...
<title>Hình thức văn bản Công văn điều hành | Hệ thống quản lý công văn, văn bản</title>
<!-- InstanceEndEditable -->
...
<div  class="wrapper">
    ...
    <div class="content">
        ...
        <?php 
			 if(isset($_SESSION['user'])){include_once "Table_admin_congvandieuhanh.php";}
			 else{
				 include_once "Table_index_congvandieuhanh.php";
				 } 
		?>
		<!-- InstanceEndEditable -->
        </div>
