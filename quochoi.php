...
<div  class="wrapper">
          ...
          <!--start search form-->
            <div class="form-search">
                <form id="form-search" name="form1" method="get" action="search_index_quochoi.php">
                  <input type="text" class="txt-search" name="txt-search" id="txt-search" placeholder="Nhập từ khoá cần tìm ..." />
                  <input type="submit" class="btn-search" name="btn-search" id="btn-search" size="40" maxlength="4value="Tìm kiếm"ếm" />
                </form>
            </div>  
        <!--end search form-->   
		</div>
    ...
    <div class="content">
        ...
        <?php 
			 if(isset($_SESSION['user'])){include_once "Table_admin_quochoi.php";}
			 else{
				 include_once "Table_index_quochoi.php";
				 } 
		?>
		<!-- InstanceEndEditable -->
        </div>
