			    ...
			    <input type="submit" name="btn_Search" value="Tìm kiếm">
					...
					$con = mysqli_connect("localhost","root","","quanlycongvan") ;
			                ...
			                if (mysqli_connect_errno()) {
								...
								$sodong_dulieu = mysqli_num_rows($result) ;
								
								$sotrang = $sodong_dulieu/$baitren_mottrang;
								
								$query = "SELECT * FROM congvan, taptin WHERE congvan.taptin = taptin.id GROUP BY id limit ".($page-1) * $baitren_mottrang. "," .$baitren_mottrang;
